...
def buscar_passagens(origem, destino, data_ida, data_volta):
    ...
    for top_flights in resultado['topFlights']:
        ...
        codigo_aero_chegada = top_flights['flights'][0]['arrival_airport']['airport_code']
        companhia = top_flights['flights'][0]['airline']
        preco = top_flights['price']

        sql_top_flights = '''
        INSERT INTO topflights
        (data_partida,
        data_chegada,
        duracao,
        aeroporto_partida,
...
if __name__ == '__main__':
    ...
    buscar_passagens(origem='SDU', destino='GRU',
                     data_ida='2025-03-25', data_volta='2025-03-28')
